...
Columns: Lot | Description | Qty | Unit | Equip. | Labour | Basic | High-End | Luxury
...
def _row(lot, desig, qte, unite, pu_b, pu_h, pu_l, cat='default', bold=False):
    """Build a 9-column row: Lot | Description | Qty | Unit | Equip. | Labour | Basic | H-E | Luxury"""
...
def _build(rm):
    ...
    story.append(Paragraph(
        ...
        S['body']))
    story.append(Paragraph(
        'Unit prices local market 2026 split into equipment and labour. Margin ±15%. '
    ...
    rows_elec.append(_sous_total('SUBTOTAL LOT E', c_elec_b, c_elec_h, c_elec_l, 'cablage'))
    ...
    rows_plomb.append(_sous_total('SUBTOTAL LOT P', c_pl_b, c_pl_h, c_pl_l, 'tuyauterie'))
    ...
    rows_cvc.append(_sous_total('SUBTOTAL LOT C', c_cv_b, c_cv_h, c_cv_l, 'split'))
    ...
    rows_cf.append(_sous_total('SUBTOTAL LOT CF', c_cf_b, c_cf_h, c_cf_l, 'rj45'))
    ...
    rows_si.append(_sous_total('SUBTOTAL LOT SI', c_si_b, c_si_h, c_si_l, 'detecteur'))
    ...
    if asc.nb_ascenseurs > 0:
        ...
        rows_asc.append(_sous_total('SUBTOTAL LOT ASC', c_asc_b, c_asc_h, c_asc_l, 'ascenseur'))
    ...
    rows_auto.append(_sous_total('SUBTOTAL LOT AUTO', c_auto_b, c_auto_h, c_auto_l, 'default'))
    ...
    total_eq_b, total_po_b = _split_ep(total_b, 'default')
